        ...
        <div class="slider" id="sliders">
            <div class="slider-head">
                <div class="d-block pt-4 pb-3 px-3">
                    ...
                    <p class="fw-bold mb-0 lh-1 text-white">Administrator</p>
            ...
            <div class="slider-body px-1">
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link px-3" href="#">
                        <i class="fa fa-dropbox fa-lg box-icon" aria-hidden="true"></i>Data Produk
                    </a>
                    <hr class="soft my-1 bg-white">
                    <a class="nav-link px-3" href="#">
                        <i class="fa fa-user fa-lg box-icon" aria-hidden="true"></i>Data Customer
                    </a>
                    <a class="nav-link px-3" href="#">
                        <i class="fa fa-user fa-lg box-icon" aria-hidden="true"></i>Data Admin
                    </a>
                    <a class="nav-link px-3" href="#">
                        <i class="fa fa-calendar fa-lg box-icon" aria-hidden="true"></i>Laporan Penjualan
                    </a>
                    <hr class="soft my-1 bg-white">
                    
                    <a class="nav-link px-3" href="#">
                        <i class="fa fa-envelope fa-lg box-icon" aria-hidden="true"></i>Transaksi
                    </a>
                    <hr class="soft my-1 bg-white">
                    <!-- <a class="nav-link px-3" href="#">
